...
ActiveRecord::Schema[8.0].define(version: 2025_10_30_000000) do
  ...
  create_table "ballots", force: :cascade do |t|
    ...
    t.index ["user_id", "week"], name: "index_ballots_on_user_id_and_week"
  ...
  create_table "meeple_cosmetics", force: :cascade do |t|
    t.integer "meeple_id", null: false
  ...
  create_table "physical_items", force: :cascade do |t|
    ...
    t.index ["digital"], name: "index_physical_items_on_digital"
  ...
  create_table "shop_purchases", force: :cascade do |t|
    ...
    t.index ["user_id", "item_name"], name: "index_shop_purchases_unique_one_time", unique: true, where: "((item_name)::text = ANY (ARRAY[('Unlock Orange Meeple'::character varying)::text, ('Random Sticker'::character varying)::text]))"
